...
public final class RegexUtils {
	/**
	 * 功能描述:验证输入的字符是否为double型,是则返回true，不是或包含非法字符册返回false <br>
	 * 〈功能详细描述〉
	 * 
	 * @param str
	 *            您要输入的参数，为String型
...
public static void main(String[] args) {
	//queency.yang@huakangpharma.com
	System.out.println(RegexUtils.checkEmail("queency.yang@huakangpharma.com"));
}
}
